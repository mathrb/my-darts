...
/// Per-3-dart-turn average for count-up (PPR).
///
/// Same shape as `X01AverageProjection` — total scored points divided by
/// total darts thrown × 3. Count-up has no bust, so every dart's score
/// always contributes; the projection still uses TurnEnded as the flush
/// boundary to keep the per-turn semantic identical to X01.
class CountUpAverageProjection extends ProjectionEngine {
