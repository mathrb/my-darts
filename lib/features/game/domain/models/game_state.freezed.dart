...
@useResult
$Res call({
 String gameId, GameType gameType, List<CompetitorState> competitors, int currentTurnIndex, int dartsThrownInTurn, bool isComplete, String? winnerCompetitorId, GameEngineStatus status, bool turnActive, int legsToWin, int currentLegIndex, int currentRoundInLeg, int? x01TotalRounds, String inStrategy, String outStrategy, int startingScore, String cricketVariant, String aroundTheClockVariant, int shanghaiTotalRounds, int catch40TargetRemaining, int catch40DartsOnTarget, List<int> checkoutPracticeOrder
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String gameId,  GameType gameType,  List<CompetitorState> competitors,  int currentTurnIndex,  int dartsThrownInTurn,  bool isComplete,  String? winnerCompetitorId,  GameEngineStatus status,  bool turnActive,  int legsToWin,  int currentLegIndex,  int currentRoundInLeg,  int? x01TotalRounds,  String inStrategy,  String outStrategy,  int startingScore,  String cricketVariant,  String aroundTheClockVariant,  int shanghaiTotalRounds,  int catch40TargetRemaining,  int catch40DartsOnTarget,  List<int> checkoutPracticeOrder)  $default,) {final _that = this;
switch (_that) {
case _GameState():
return $default(_that.gameId,_that.gameType,_that.competitors,_that.currentTurnIndex,_that.dartsThrownInTurn,_that.isComplete,_that.winnerCompetitorId,_that.status,_that.turnActive,_that.legsToWin,_that.currentLegIndex,_that.currentRoundInLeg,_that.x01TotalRounds,_that.inStrategy,_that.outStrategy,_that.startingScore,_that.cricketVariant,_that.aroundTheClockVariant,_that.shanghaiTotalRounds,_that.catch40TargetRemaining,_that.catch40DartsOnTarget,_that.checkoutPracticeOrder);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String gameId,  GameType gameType,  List<CompetitorState> competitors,  int currentTurnIndex,  int dartsThrownInTurn,  bool isComplete,  String? winnerCompetitorId,  GameEngineStatus status,  bool turnActive,  int legsToWin,  int currentLegIndex,  int currentRoundInLeg,  int? x01TotalRounds,  String inStrategy,  String outStrategy,  int startingScore,  String cricketVariant,  String aroundTheClockVariant,  int shanghaiTotalRounds,  int catch40TargetRemaining,  int catch40DartsOnTarget,  List<int> checkoutPracticeOrder)?  $default,) {final _that = this;
switch (_that) {
case _GameState() when $default != null:
return $default(_that.gameId,_that.gameType,_that.competitors,_that.currentTurnIndex,_that.dartsThrownInTurn,_that.isComplete,_that.winnerCompetitorId,_that.status,_that.turnActive,_that.legsToWin,_that.currentLegIndex,_that.currentRoundInLeg,_that.x01TotalRounds,_that.inStrategy,_that.outStrategy,_that.startingScore,_that.cricketVariant,_that.aroundTheClockVariant,_that.shanghaiTotalRounds,_that.catch40TargetRemaining,_that.catch40DartsOnTarget,_that.checkoutPracticeOrder);case _:
  return null;
...
class _GameState implements GameState {
  const _GameState({required this.gameId, required this.gameType, required final  List<CompetitorState> competitors, required this.currentTurnIndex, required this.dartsThrownInTurn, required this.isComplete, this.winnerCompetitorId, this.status = GameEngineStatus.initialized, this.turnActive = false, this.legsToWin = 1, this.currentLegIndex = 0, this.currentRoundInLeg = 1, this.x01TotalRounds, this.inStrategy = 'straight', this.outStrategy = 'double', this.startingScore = 501, this.cricketVariant = 'standard', this.aroundTheClockVariant = 'standard', this.shanghaiTotalRounds = 7, this.catch40TargetRemaining = 0, this.catch40DartsOnTarget = 0, final  List<int> checkoutPracticeOrder = const []}): _competitors = competitors,_checkoutPracticeOrder = checkoutPracticeOrder;
